...
To update the default value of an input you don't want to expose in the UI, you need to hide it instead of deleting it. Deleting it will revert to the value that was saved in the workflow_api file you used to create the app. 
...
![ViewComfy App Editor input menu](/public/input_menu.webp) 
...
![ViewComfy App Mask Editor](/public/mask_editor.webp) 
...
![ViewComfy compare output](/public/viewcomfy_output_compare.webp)

![ViewComfy compare images output](/public/viewcomfy_compare_images_output.webp)
...
![Enable text output in your apps](/public/enable_text_output_checkbox.webp)
...
![ViewComfy show filename output](/public/viewcomfy_showfilename_output.webp)

![ViewComfy show filename full output](/public/viewcomfy_showfilename_full_output.webp)
...
![ViewComfy show filename filename prefix output](/public/viewcomfy_showfilename_filenameprefix_output.webp)

![ViewComfy show filename parsed output](/public/viewcomfy_showfilename_parsed_output.webp)
...
![PSD workflow](/public/viewcomfy_psd.webp)
...
![ViewComfy dropdown input](/public/viewcomfy_dropdown.webp)
...
![ViewComfy slider input](/public/viewcomfy_slider_input.webp)
...
![ViewComfy tooltip input](/public/viewcomfy_tooltip_input.webp)
...
![ViewComfy helptext input](/public/viewcomfy_helptext_input.webp)
